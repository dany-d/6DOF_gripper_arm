...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_task1.setText(_translate("MainWindow", "TEACH", None))
        self.btn_task2.setText(_translate("MainWindow", "RECORD", None))
        self.btn_task3.setText(_translate("MainWindow", "REPEAT", None))
        self.btn_task4.setText(_translate("MainWindow", "TRAJ", None))
        self.btn_exec_6.setText(_translate("MainWindow", "PICK&PLACE", None))
        self.btnUser1.setText(_translate("MainWindow", "USER 1", None))
        self.btnUser2.setText(_translate("MainWindow", "RELEASE", None))
        self.btnUser3.setText(_translate("MainWindow", "GRIP", None))
        self.btnUser4.setText(_translate("MainWindow", "TASK1", None))
        self.btnUser5.setText(_translate("MainWindow", "TASK2", None))
        self.btnUser6.setText(_translate("MainWindow", "TASK3", None))
        self.btnUser7.setText(_translate("MainWindow", "TASK4", None))
        self.btnUser8.setText(_translate("MainWindow", "TASK5", None))
